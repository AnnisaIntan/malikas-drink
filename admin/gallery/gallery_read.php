...
if (isset($_GET['id'])) {
    ...
    if ($hasil = mysqli_fetch_array($query)) {
        echo "<h1>Gallery Details</h1> <br>";
        echo "<table border='1'>";
        echo "<tr><td><strong>Judul Galeri:</strong></td><td>" . htmlspecialchars($hasil['judul_galeri']) . "</td></tr>";
        echo "<tr><td><strong>Tanggal Galeri:</strong></td><td>" . htmlspecialchars($hasil['tgl_galeri']) . "</td></tr>";
        echo "<tr><td><strong>Detail Galeri:</strong></td><td>" . htmlspecialchars($hasil['detail_galeri']) . "</td></tr>";
        echo "<tr><td><strong>Foto:</strong></td><td><img src='" . htmlspecialchars($hasil['foto_galeri']) . "' class='gambar'></td></tr>";
