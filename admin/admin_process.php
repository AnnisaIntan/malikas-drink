...
switch ($status) {
    case 'tambah':
        ...
        echo $admin_tambah ? "<script>alert('Tambah Data Admin Berhasil');</script>" : "<script>alert('Tambah Data Admin Gagal');</script>";
        break;
    ...
    case 'edit':
        ...
        echo $admin_edit ? "<script>alert('Edit Data Admin Berhasil');</script>" : "<script>alert('Edit Data Admin Gagal');</script>";
        break;
    ...
    default:
        if (isset($_GET['id'])) {
            ...
            echo $admin_hapus ? "<script>alert('Hapus Data Admin Berhasil');</script>" : "<script>alert('Hapus Data Admin Gagal');</script>";
        }
        break;
}
?>
<meta http-equiv="refresh" content="0; index.php?page=admin_show">